...
global_symbol_table.set("consoleprint", BuiltInFunction.print)
global_symbol_table.set("consoleprint_RET", BuiltInFunction.print_ret)
...
global_symbol_table.set("go", BuiltInFunction.run)
